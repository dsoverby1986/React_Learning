...
console.log(`Is an adult: ${__WEBPACK_IMPORTED_MODULE_0__person__["c" /* isAdult */](33)}`);
console.log(`Can drink alcohol: ${__WEBPACK_IMPORTED_MODULE_0__person__["a" /* canDrink */](12)}`);
console.log(`Is a senior citizen: ${__WEBPACK_IMPORTED_MODULE_0__person__["b" /* default */](65)}`);
