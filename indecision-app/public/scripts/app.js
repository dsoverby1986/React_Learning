            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'button',
                            { className: 'btn btn-primary', onClick: this.handleAddOne },
                            '+1'
                        )
                    ),
                    React.createElement(
                        ...
                        React.createElement(
                            'button',
                            { className: 'btn btn-warning', onClick: this.handleMinusOne },
                            '-1'
                        )
                    ),
                    React.createElement(
                        ...
                        React.createElement(
                            'button',
                            { className: 'btn btn-danger', onClick: this.handleReset },
                            'Reset'
                        )
                    )
                )
